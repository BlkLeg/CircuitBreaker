        ...
        >
          ...
          <button
            ...
            style={{
              ...
              padding: 0, lineHeight: 1, fontSize: 15, marginLeft: 2,
            }}
          >×</button>
        </div>
      ) : (
          ...
          {options === null ? (
            ...
            <>
              ...
              {filtered.map((env) => (
                <div
                  key={env.id}
                  onMouseDown={(e) => { e.preventDefault(); handleSelect(env); }}
                  style={{
                  ...
                  onMouseLeave={(e) => {
                    e.currentTarget.style.background = value === env.id ? 'var(--color-glow)' : 'transparent';
                  }}
                >
                  {env.color && (
                    <span style={{
