...
export const LIBRARY_ICONS = [
  ...
  { slug: 'cyberpower',        label: 'CyberPower',      path: '/icons/vendors/cyberpower.png',        group: 'Vendor' },
  { slug: 'raspberrypi',       label: 'Raspberry Pi',    path: '/icons/vendors/raspberrypi.png',       group: 'Vendor' },
  { slug: 'raspberrypi-light', label: 'Raspberry Pi (light)', path: '/icons/vendors/raspberrypi-light.png', group: 'Vendor' },
  // Network
  ...
  { slug: 'cloudflareworkers', label: 'CF Workers',      path: '/icons/vendors/cloudflareworkers.svg', group: 'Apps' },
  // Hardware (icons8 3D hardware pack)
  { slug: 'hw-server',         label: 'Server',          path: '/icons/hardware/icons8-server-50.png',              group: 'Hardware' },
  { slug: 'hw-root-server',    label: 'Root Server',     path: '/icons/hardware/icons8-root-server-50.png',         group: 'Hardware' },
  { slug: 'hw-nas',            label: 'NAS',             path: '/icons/hardware/icons8-nas-50.png',                 group: 'Hardware' },
  { slug: 'hw-workstation',    label: 'Workstation',     path: '/icons/hardware/icons8-workstation-50.png',         group: 'Hardware' },
  { slug: 'hw-laptop',         label: 'Laptop',          path: '/icons/hardware/icons8-laptop-with-cursor-50.png',  group: 'Hardware' },
  { slug: 'hw-monitor',        label: 'Monitor',         path: '/icons/hardware/icons8-monitor-50.png',             group: 'Hardware' },
  { slug: 'hw-monitor-alt',    label: 'Monitor (alt)',   path: '/icons/hardware/icons8-monitor-50-2.png',           group: 'Hardware' },
  ...
  { slug: 'hw-m2-ssd',         label: 'M.2 SSD',         path: '/icons/hardware/icons8-m.2-ssd-50.png',            group: 'Hardware' },
  { slug: 'hw-microchip',      label: 'Microchip',       path: '/icons/hardware/icons8-microchip-50.png',           group: 'Hardware' },
  { slug: 'hw-ai-chip',        label: 'AI Chip',         path: '/icons/hardware/icons8-3d-black-ai-chip-50.png',    group: 'Hardware' },
  { slug: 'hw-ai-component',   label: 'AI Component',    path: '/icons/hardware/icons8-3d-ai-component-50.png',     group: 'Hardware' },
  { slug: 'hw-gpu',            label: 'GPU',             path: '/icons/hardware/icons8-video-card-50.png',          group: 'Hardware' },
  { slug: 'hw-network-card',   label: 'Network Card',    path: '/icons/hardware/icons8-network-card-50.png',        group: 'Hardware' },
  { slug: 'hw-ethernet-on',    label: 'Ethernet (on)',   path: '/icons/hardware/icons8-ethernet-on-50.png',         group: 'Hardware' },
  { slug: 'hw-ethernet-off',   label: 'Ethernet (off)',  path: '/icons/hardware/icons8-ethernet-off-50.png',        group: 'Hardware' },
  { slug: 'hw-hardware',       label: 'Hardware',        path: '/icons/hardware/icons8-hardware-50.png',            group: 'Hardware' },
  { slug: 'hw-device-manager', label: 'Device Manager',  path: '/icons/hardware/icons8-device-manager-50.png',     group: 'Hardware' },
  { slug: 'hw-rpi-zero',       label: 'Raspberry Pi Zero', path: '/icons/hardware/icons8-raspberry-pi-zero-50.png', group: 'Hardware' },
  { slug: 'hw-stack',          label: 'Stack',           path: '/icons/hardware/icons8-stack-50.png',               group: 'Hardware' },
  { slug: 'hw-keyboard',       label: 'Keyboard',        path: '/icons/hardware/icons8-keyboard-50.png',            group: 'Hardware' },
  { slug: 'hw-usb',            label: 'USB Drive',       path: '/icons/hardware/icons8-usb-memory-stick-50.png',    group: 'Hardware' },
  // Network 3D (icons8 3D network pack)
  { slug: 'net-hub',           label: 'Hub',             path: '/icons/network/icons8-hub-50.png',                  group: 'Network' },
  { slug: 'net-switch',        label: 'Switch (3D)',      path: '/icons/network/icons8-switch-50.png',              group: 'Network' },
  { slug: 'net-nas',           label: 'NAS (3D)',         path: '/icons/network/icons8-nas-50.png',                 group: 'Network' },
  { slug: 'net-wifi',          label: 'Wi-Fi',           path: '/icons/network/icons8-wi-fi-50.png',                group: 'Network' },
  { slug: 'net-wifi-router',   label: 'Wi-Fi Router',    path: '/icons/network/icons8-wi-fi-router-50.png',         group: 'Network' },
  { slug: 'net-wifi-connected', label: 'Wi-Fi Connected', path: '/icons/network/icons8-wi-fi-connected-50.png',    group: 'Network' },
  { slug: 'net-wifi-disconnected', label: 'Wi-Fi Disconnected', path: '/icons/network/icons8-wi-fi-disconnected-50.png', group: 'Network' },
  { slug: 'net-wifi-good',     label: 'Wi-Fi Good',      path: '/icons/network/icons8-wi-fi-good-50.png',           group: 'Network' },
  { slug: 'net-wifi-fair',     label: 'Wi-Fi Fair',      path: '/icons/network/icons8-wi-fi-fair-50.png',           group: 'Network' },
  { slug: 'net-wifi-weak',     label: 'Wi-Fi Weak',      path: '/icons/network/icons8-wi-fi-weak-50.png',           group: 'Network' },
  { slug: 'net-wifi-off',      label: 'Wi-Fi Off',       path: '/icons/network/icons8-wi-fi-off-50.png',            group: 'Network' },
  { slug: 'net-cloud',         label: 'Cloud',           path: '/icons/network/icons8-cloud-50.png',                group: 'Network' },
  { slug: 'net-cloud-dev',     label: 'Cloud Dev',       path: '/icons/network/icons8-cloud-development-50.png',    group: 'Network' },
  { slug: 'net-cloud-storage', label: 'Cloud Storage',   path: '/icons/network/icons8-cloud-storage-50.png',        group: 'Network' },
  { slug: 'net-cloud-sync',    label: 'Cloud Sync',      path: '/icons/network/icons8-cloud-sync-50.png',           group: 'Network' },
  { slug: 'net-cloud-download', label: 'Cloud Download', path: '/icons/network/icons8-download-from-cloud-50.png', group: 'Network' },
  { slug: 'net-cloud-upload',  label: 'Cloud Upload',    path: '/icons/network/icons8-upload-to-cloud-50.png',      group: 'Network' },
  { slug: 'net-cloud-secure',  label: 'Secure Cloud',    path: '/icons/network/icons8-secure-cloud-50.png',         group: 'Network' },
  { slug: 'net-connected',     label: 'Connected',       path: '/icons/network/icons8-connected-50.png',            group: 'Network' },
  { slug: 'net-disconnected',  label: 'Disconnected',    path: '/icons/network/icons8-disconnected-50.png',         group: 'Network' },
  { slug: 'net-cable',         label: 'Network Cable',   path: '/icons/network/icons8-network-cable-50.png',        group: 'Network' },
  { slug: 'net-decentralized', label: 'Decentralized',   path: '/icons/network/icons8-decentralized-network-50.png', group: 'Network' },
  { slug: 'net-wired',         label: 'Wired Network',   path: '/icons/network/icons8-wired-network-50.png',        group: 'Network' },
  { slug: 'net-bluetooth',     label: 'Bluetooth',       path: '/icons/network/icons8-bluetooth-50.png',            group: 'Network' },
  { slug: 'net-broadcast',     label: 'Broadcasting',    path: '/icons/network/icons8-broadcasting-50.png',         group: 'Network' },
  { slug: 'net-website',       label: 'Website',         path: '/icons/network/icons8-website-50.png',              group: 'Network' },
  // Network Color (icons8 liquid glass)
  { slug: 'netc-server',       label: 'Server (color)',  path: '/icons/network-color/icons8-server-50.png',         group: 'Network' },
  { slug: 'netc-hub',          label: 'Hub (color)',     path: '/icons/network-color/icons8-hub-50.png',            group: 'Network' },
  { slug: 'netc-switch',       label: 'Switch (color)',  path: '/icons/network-color/icons8-switch-50.png',         group: 'Network' },
  { slug: 'netc-nas',          label: 'NAS (color)',     path: '/icons/network-color/icons8-nas-50.png',            group: 'Network' },
  { slug: 'netc-wifi',         label: 'Wi-Fi (color)',   path: '/icons/network-color/icons8-wi-fi-50.png',          group: 'Network' },
  { slug: 'netc-wifi-router',  label: 'Wi-Fi Router (color)', path: '/icons/network-color/icons8-wi-fi-router-50.png', group: 'Network' },
  { slug: 'netc-internet',     label: 'Internet (color)', path: '/icons/network-color/icons8-internet-50.png',     group: 'Network' },
  { slug: 'netc-cloud',        label: 'Cloud (color)',   path: '/icons/network-color/icons8-cloud-50.png',          group: 'Network' },
  { slug: 'netc-cloud-storage', label: 'Cloud Storage (color)', path: '/icons/network-color/icons8-cloud-storage-50.png', group: 'Network' },
  { slug: 'netc-connected',    label: 'Connected (color)', path: '/icons/network-color/icons8-connected-50.png',   group: 'Network' },
  { slug: 'netc-disconnected', label: 'Disconnected (color)', path: '/icons/network-color/icons8-disconnected-50.png', group: 'Network' },
  { slug: 'netc-no-connection', label: 'No Connection', path: '/icons/network-color/icons8-no-connection-50.png',  group: 'Network' },
  { slug: 'netc-stack',        label: 'Stack (color)',   path: '/icons/network-color/icons8-stack-50.png',          group: 'Network' },
  { slug: 'netc-linux-server', label: 'Linux Server',   path: '/icons/network-color/icons8-linux-server-50.png',   group: 'Network' },
  // Security (icons8 sec_access pack)
  { slug: 'sec-firewall',      label: 'Firewall (3D)',   path: '/icons/security/icons8-firewall-50.png',            group: 'Security' },
  { slug: 'sec-lock',          label: 'Lock',            path: '/icons/security/icons8-lock-50.png',                group: 'Security' },
  { slug: 'sec-unlock',        label: 'Unlock',          path: '/icons/security/icons8-unlock-50.png',              group: 'Security' },
  { slug: 'sec-password',      label: 'Password',        path: '/icons/security/icons8-password-50.png',            group: 'Security' },
  { slug: 'sec-password-key',  label: 'Password Key',    path: '/icons/security/icons8-password-key-50.png',        group: 'Security' },
  { slug: 'sec-protect',       label: 'Protect',         path: '/icons/security/icons8-protect-50.png',             group: 'Security' },
  { slug: 'sec-shield-delete', label: 'Shield Delete',   path: '/icons/security/icons8-delete-shield-50.png',       group: 'Security' },
  { slug: 'sec-restrict',      label: 'Restrict',        path: '/icons/security/icons8-restrict-50.png',            group: 'Security' },
  { slug: 'sec-wall',          label: 'Brick Wall',      path: '/icons/security/icons8-brick-wall-50.png',          group: 'Security' },
  { slug: 'sec-fence',         label: 'Fence',           path: '/icons/security/icons8-fence-50.png',               group: 'Security' },
  { slug: 'sec-access',        label: 'Access',          path: '/icons/security/icons8-access-50.png',              group: 'Security' },
  { slug: 'sec-fingerprint',   label: 'Fingerprint',     path: '/icons/security/icons8-fingerprint-50.png',         group: 'Security' },
  { slug: 'sec-fingerprint-ok', label: 'Fingerprint OK', path: '/icons/security/icons8-fingerprint-accepted-50.png', group: 'Security' },
  { slug: 'sec-face-id',       label: 'Face ID',         path: '/icons/security/icons8-face-id-50.png',             group: 'Security' },
  { slug: 'sec-touch-id',      label: 'Touch ID',        path: '/icons/security/icons8-touch-id-50.png',            group: 'Security' },
  { slug: 'sec-smart-card',    label: 'Smart Card',      path: '/icons/security/icons8-smart-card-reader-50.png',   group: 'Security' },
  // Devices (camera pack)
  { slug: 'cam-camera',        label: 'Camera',          path: '/icons/camera/icons8-camera-50.png',                group: 'Devices' },
  { slug: 'cam-webcam',        label: 'Webcam',          path: '/icons/camera/icons8-webcam-50.png',                group: 'Devices' },
  { slug: 'cam-wall-mount',    label: 'Wall Camera',     path: '/icons/camera/icons8-wall-mount-camera-50.png',     group: 'Devices' },
  { slug: 'cam-camcorder',     label: 'Camcorder',       path: '/icons/camera/icons8-camcorder-50.png',             group: 'Devices' },
  // Power (UPS pack)
