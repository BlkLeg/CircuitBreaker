            ...
            <tr key={field} style={{ borderBottom: '1px solid var(--color-border)' }}>
              ...
              <td style={tdStyle}>
                <label style={{ display: 'flex', alignItems: 'center', gap: 6, cursor: 'pointer' }}>
                  ...
                  />
                  <span style={{ color: selections[field] === 'existing' ? 'var(--color-text)' : 'var(--color-text-muted)' }}>
                    {String(stored ?? '—')}
                  </span>
                </label>
              </td>
              <td style={tdStyle}>
                <label style={{ display: 'flex', alignItems: 'center', gap: 6, cursor: 'pointer' }}>
                  ...
                  />
                  <span style={{ color: selections[field] === 'discovered' ? 'var(--color-primary)' : 'var(--color-text-muted)' }}>
                    {String(discovered ?? '—')}
                  </span>
                </label>
              </td>
