...
import { 
  X, Server, Router, Network, Shield, Wifi, HardDrive, Zap, Plug, Laptop, Monitor, Box, Package, Cloud 
} from 'lucide-react';
          ...
          >
            ...
            >
              <div className="tw-flex tw-items-center tw-justify-between tw-px-6 tw-py-4 tw-border-b tw-border-cb-border tw-bg-cb-secondary">
                <h3 id="create-node-modal-title" className="tw-text-cb-text tw-font-bold tw-text-lg tw-font-mono">Create New Node</h3>
                <button
                  type="button"
                  onClick={onClose}
              ...
              <div className="tw-flex tw-flex-1 tw-overflow-hidden">
                ...
                <div className="tw-w-1/2 tw-p-6 tw-border-r tw-border-cb-border tw-overflow-y-auto">
                  <form id="create-node-form" onSubmit={handleSubmit} className="tw-space-y-6">
                    <div>
                      <label htmlFor="create-node-name" className="tw-block tw-text-xs tw-font-bold tw-text-cb-text tw-uppercase tw-tracking-wider tw-mb-2">
                        Name / Device Lookup
                      </label>
                      <input
                        id="create-node-name"
                    ...
                    <div>
                      <label htmlFor="create-node-ip" className="tw-block tw-text-xs tw-font-bold tw-text-cb-text tw-uppercase tw-tracking-wider tw-mb-2">
                        IP Address
                      </label>
                      <input
                        id="create-node-ip"
                    ...
                    <div>
                      ...
                      <div className="tw-flex tw-items-center tw-gap-3 tw-p-3 tw-rounded-lg tw-bg-cb-secondary tw-border tw-border-cb-border">
                        ...
                        <div>
                          <div className="tw-text-cb-text tw-font-medium tw-text-sm">{selectedRole.label}</div>
                ...
                <div className="tw-w-1/2 tw-bg-cb-bg tw-flex tw-flex-col">
                  <div className="tw-px-4 tw-py-3 tw-border-b tw-border-cb-border tw-bg-cb-secondary">
                    <span className="tw-text-xs tw-font-bold tw-text-cb-text tw-uppercase tw-tracking-wider">Select Role</span>
                  </div>
