    ...
    <div ref={menuRef} style={{ position: 'relative', display: 'inline-block' }}>
      ...
      {open && !isActive && (
        ...
        >
          ...
          >
            <span>Boundary</span>
            <ChevronDown size={12} style={{ transform: expandedSection === 'boundary' ? 'rotate(180deg)' : 'none', transition: 'transform 0.15s' }} />
          </button>
          ...
          >
            ...
            <ChevronDown size={12} style={{ transform: expandedSection === 'line' ? 'rotate(180deg)' : 'none', transition: 'transform 0.15s' }} />
          </button>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 5 }}>
                {CONNECTION_TYPE_OPTIONS.map((type) => {
                  ...
                  return (
                    ...
                    >
                      <Minus size={14} style={{ color: cs?.stroke, strokeWidth: cs?.strokeWidth || 2 }} />
                      {type}
                    </button>
                  );
                })}
          ...
          >
            <span>Label</span>
            <ChevronDown size={12} style={{ transform: expandedSection === 'label' ? 'rotate(180deg)' : 'none', transition: 'transform 0.15s' }} />
          </button>
