...
> `490c95b0`. Slices 4.4-4.5 are out of scope for this design and remain
> unstarted.
...
- Modify: `docs/evidence/2026-08-30-production-readiness-route.md` (F4 row, Phase 4 progress)
...
In `docs/evidence/2026-08-30-production-readiness-route.md`, change the F4 row's status from "Still verified" to record what shipped, and note the two findings that widened it (four dial sites including the update download; mode transitions stranding the fleet in both directions). Tick slice 4.1 in the Phase 4 table.
...
git add apps/agent/e2e/ docs/tls-trust-rotation.md docs/agent-key-rotation.md \
        docs/evidence/2026-08-30-production-readiness-route.md
...
- Modify: `apps/agent/e2e/test_agent_e2e.py`
- Modify: `docs/agent.md`, `docs/evidence/2026-08-30-production-readiness-route.md`
...
_SCAN_SKIP_DIRS = (
    ...
    "build/",
    ".superpowers/",
    # Registered git worktrees live here and hold FULL copies of the source
    # tree. A repo-wide scan that does not skip them reports every finding
    # three or four times over, attributed to paths that are not this
    # checkout. An existing repo-policy test
    # (tests/services/test_discovery_worker_job_consumer.py) is red for
    # exactly this reason.
    ".claude/",
)
...
In `docs/evidence/2026-08-30-production-readiness-route.md`, update the F3 row and tick slice 4.2, recording that it ships in **warn** mode and naming the release enforcement is scheduled for.
...
git add .github/workflows/release.yml scripts/build_native_release.py \
        ...
        docs/agent.md docs/evidence/2026-08-30-production-readiness-route.md
...
**Files:**
- Modify: `tests/build/test_phase4_supply_chain_ratchets.py`
- Modify: `docs/audit-log.md`, `docs/evidence/2026-08-30-production-readiness-route.md`
...
In `docs/evidence/2026-08-30-production-readiness-route.md`, update the F17 row and tick slice 4.3.
