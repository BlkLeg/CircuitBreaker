...
_EXCLUDED_COLUMNS: dict[str, set[str]] = {
    ...
    "hardware": {"integration_config_id", "proxmox_node_name", "tenant_id"},
    "hardware_cluster_members": {"member_type", "service_id"},
    "hardware_clusters": {"integration_config_id", "tenant_id", "type"},
    "logs": {"log_hash", "previous_hash", "role_at_time", "session_id"},
    "networks": {"tenant_id"},
    "scan_jobs": {"network_ids", "source_type", "tenant_id", "vlan_ids"},
    "scan_results": {"banner", "network_id", "os_accuracy", "source_type", "vlan_id"},
    "services": {"docker_labels", "tenant_id"},
