 ...
 * receives Critical. A dispatcher comparing for equality would make the
 * "Minimum Severity" label promise a threshold the backend does not implement.
 * Both surfaces that show or offer the field read their wording from
