  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <h2
          style={{ margin: 0, fontSize: 20, fontWeight: 600, color: 'var(--color-text, #e0e0e0)' }}
        >
          Something went wrong
        </h2>
        <p
          style={{ margin: 0, color: 'var(--color-text-muted, #888)', maxWidth: 420, fontSize: 14 }}
        >
          An unexpected error occurred while rendering this page. You can try reloading — your data
          is safe.
        </p>
        {this.state.error && (
          <pre
