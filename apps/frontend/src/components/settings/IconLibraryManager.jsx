          ...
          displayGroups.map((group) => {
            ...
            return (
              <div key={group} style={{ marginBottom: 20 }}>
                <SectionLabel count={icons.length}>
                  {group === 'UPLOADED' ? 'Uncategorized Custom' : group}
                </SectionLabel>
        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
              <button className="btn btn-sm" onClick={() => setUploadPrompt(null)}>
                Cancel
              </button>
              <button className="btn btn-sm btn-primary" onClick={confirmUpload}>
                Upload
              </button>
            </div>
          </div>
