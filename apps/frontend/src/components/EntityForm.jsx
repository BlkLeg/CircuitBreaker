      ...
      return (
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <button
            ...
            onClick={() =>
              field.onOpenPicker?.(slug, (newSlug) => handleIconChange(field.name, newSlug))
            }
          >
          ...
          {slug && (
            <button
              ...
              onClick={() => setValues((prev) => ({ ...prev, [field.name]: null }))}
            >
              ✕
            </button>
          )}
    ...
    if (field.type === 'image-upload') {
      ...
      return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          ...
          />
          {isUploading && (
            <span style={{ fontSize: 12, color: 'var(--color-text-muted)' }}>Uploading…</span>
          )}
          {previewUrl && (
            <img
              src={previewUrl}
