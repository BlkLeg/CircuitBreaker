              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    background:
                      tz === value ? 'var(--color-glow, rgba(99,179,237,0.08))' : 'transparent',
                    display: 'flex',
                    alignItems: 'center',
                    gap: 8,
                    borderBottom:
                      isPinned && tz === PINNED_TIMEZONES[PINNED_TIMEZONES.length - 1]
                        ? '1px solid var(--color-border)'
                        : 'none',
                  }}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background =
                      'var(--color-surface-alt, rgba(255,255,255,0.05))';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.background =
                      tz === value ? 'var(--color-glow, rgba(99,179,237,0.08))' : 'transparent';
