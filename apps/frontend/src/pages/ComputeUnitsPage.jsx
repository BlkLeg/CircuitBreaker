    ...
    <div className="page">
      ...
      {settings?.show_page_hints && (
        <div className="info-tip">
          💡 <strong>Hierarchy tip:</strong> A <em>Hardware</em> node is a physical machine. A{' '}
          <em>Compute Unit</em> is a VM or container running on that hardware. Services then run
          inside compute units (or directly on hardware for bare-metal). One hardware node can host
          many compute units.
        </div>
      )}
