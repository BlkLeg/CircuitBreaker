...
/**
 * The map workspace: composes the ownership hooks and the presentation
 * components into the working page.
 *
 * Everything above this line is a route concern (map list, active map, keyed
 * providers) and lives in `pages/MapPage.jsx`; everything below is the map
 * itself. Splitting them is what makes the route shell readable.
 */
...
MapWorkspace.propTypes = {
  mapId: PropTypes.oneOfType([PropTypes.number, PropTypes.string]),
