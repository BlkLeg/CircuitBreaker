import { NODE_STYLES, BASE_NODE_STYLE, resolveNodeIcon, getEdgeColor } from './mapConstants';
import { getNodeRank } from '../../../utils/mapDataUtils';
import { normalizeConnectionType } from './connectionTypes';
import { isUpdatableEdgeId } from './linkMutations';
import {
  ADHOC_EDGE_COLOR,
